...
const mockProducts = {
  ...
  "2": {
    ...
    price: 28.9,
    originalPrice: null,
    images: ["/saco-cimento-50kg.png", "/cimento-portland-votorantim.png", "/cimento-em-po.png"],
    rating: 4.6,
    reviews: 89,
    badge: "Oferta",
  ...
  "3": {
    ...
    price: 189.9,
    originalPrice: 249.9,
    images: ["/placeholder-rv7x6.png", "/makita-cordless-screwdriver.png", "/makita-screwdriver-kit.png"],
    rating: 4.7,
    reviews: 203,
    badge: "Promoção",
        ...
        <div className="bg-slate-50 py-4">
          <div className="container mx-auto px-4">
            <Breadcrumb
              items={[
                { label: "Início", href: "/" },
                { label: product.categoryName, href: `/categoria/${product.category}` },

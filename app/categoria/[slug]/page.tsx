...
const categoryData = {
  ...
  materiais: {
    name: "Materiais",
    description: "Materiais básicos para construção: cimento, areia, tijolos e mais",
    totalProducts: 1800,
  },
  eletrica: {
    name: "Elétrica",
    description: "Materiais elétricos: fios, tomadas, disjuntores e componentes",
    totalProducts: 3200,
  },
  hidraulica: {
    name: "Hidráulica",
    description: "Materiais hidráulicos: tubos, conexões, registros e acessórios",
    totalProducts: 1500,
  },
  tintas: {
    name: "Tintas",
        ...
        <div className="bg-slate-50 py-8">
          <div className="container mx-auto px-4">
            ...
            <div className="mt-6">
              ...
              <p className="text-lg text-slate-600 mb-2">{category.description}</p>
              <p className="text-sm text-slate-500">{category.totalProducts.toLocaleString()} produtos encontrados</p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col lg:flex-row gap-8">
            <aside className="lg:w-1/4">
              <CategoryFilters category={params.slug} searchParams={searchParams} />
            </aside>

            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">{new Date(orderData.createdAt).toLocaleDateString("pt-BR")}</p>
                </div>
                <div>
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between font-bold">
                  <span>Total</span>
                  <span>R$ {(orderData.total + 15.9).toFixed(2).replace(".", ",")}</span>
                </div>
              </div>
            </CardContent>
          </Card>
                ...
                {orderData.paymentMethod === "pix" && (
                  <div className="p-3 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-blue-700">
                      O código PIX foi enviado para seu email. Efetue o pagamento para confirmar o pedido.
                    </p>
                  </div>
                )}
                {orderData.paymentMethod === "boleto" && (
                  <div className="p-3 bg-yellow-50 rounded-lg">
                    <p className="font-medium text-yellow-800">Boleto Bancário</p>
                    <p className="text-yellow-700">
                      O boleto foi enviado para seu email. Prazo de vencimento: 3 dias úteis.
                    </p>
                  </div>
                )}
                {orderData.paymentMethod === "credit-card" && (
                  <div className="p-3 bg-green-50 rounded-lg">
                    <p className="font-medium text-green-800">Cartão de Crédito</p>
                    <p className="text-green-700">Pagamento aprovado! Seu pedido será processado e enviado em breve.</p>
                  </div>
                )}
                <p>• Você receberá um email de confirmação com todos os detalhes</p>

...
const mockReviews = [
  ...
  },
  {
    ...
    date: "05/12/2024",
    title: "Recomendo",
    comment: "Uso profissionalmente há 2 meses e está funcionando perfeitamente. Ótimo custo-benefício.",
    helpful: 15,
    notHelpful: 2,
  },
]
    ...
    <div className="mb-12">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-3">
          ...
          <TabsTrigger value="reviews">Avaliações ({mockReviews.length})</TabsTrigger>
        </TabsList>

        <TabsContent value="description" className="mt-6">
          <Card>
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-slate-900 mb-4">Características do Produto</h3>
        ...
        <TabsContent value="specifications" className="mt-6">
          <Card>
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-slate-900 mb-4">Especificações Técnicas</h3>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-8">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-slate-600 mt-1">156 avaliações</div>
                  </div>
                    ...
                    {[5, 4, 3, 2, 1].map((stars) => (
                      <div key={stars} className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-sm text-slate-600 w-8">
                          {stars === 5 ? 109 : stars === 4 ? 31 : stars === 3 ? 8 : stars === 2 ? 5 : 3}
                        </span>
                      </div>
                    ))}
                  </div>

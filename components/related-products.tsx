...
export function RelatedProducts({ currentProductId, category }: RelatedProductsProps) {
  ...
  return (
    <section>
      <div className="mb-8">
        <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">Produtos Relacionados</h2>
        <p className="text-slate-600">Outros produtos que podem interessar você</p>
      </div>

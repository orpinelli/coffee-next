        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-between text-slate-600">
            ...
            <span className="text-green-600 font-medium">
              {cartData.shipping === 0 ? "Grátis" : `R$ ${cartData.shipping.toFixed(2).replace(".", ",")}`}
            </span>
          </div>
          ...
          <div className="text-center text-sm text-slate-600">
            Em até 12x de R$ {(cartData.total / 12).toFixed(2).replace(".", ",")} sem juros
          </div>

          <Button className="w-full bg-orange-600 hover:bg-orange-700 text-white" size="lg" asChild>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">Para compras acima de R$ 299</p>
              </div>
            </div>
            <div className="flex items-center gap-3">

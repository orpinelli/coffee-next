					...
					<div className="flex items-center gap-4">
						...
						>
							<Link href="/carrinho">
								...
								{itemCount > 0 && (
									<Badge className="absolute -top-2 -right-2 bg-orange-600 text-white animate-pulse">
										{itemCount}
									</Badge>
								)}
							</Link>

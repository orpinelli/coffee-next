...
import { CreditCard, Smartphone, FileText, Shield, Clock, CheckCircle } from "lucide-react"
...
export function PaymentMethods({ onPaymentSuccess, isProcessing }: PaymentMethodsProps) {
      ...
      <CardContent className="space-y-6">
            ...
            {selectedMethod === "boleto" && (
              <div className="ml-6 p-4 border rounded-lg bg-yellow-50">
                <div className="flex items-center gap-2 text-yellow-800 mb-2">
                  <Clock className="w-4 h-4" />
                  <span className="font-medium">Prazo de vencimento: 3 dias úteis</span>
                </div>
                <p className="text-sm text-yellow-700">
                  O boleto será gerado após a confirmação do pedido. O prazo para processamento é de até 2 dias úteis
                  após o pagamento.
                </p>
              </div>
            )}
        ...
        <div className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              Seus dados estão protegidos com criptografia SSL de 256 bits. Não armazenamos informações do seu cartão.
            </AlertDescription>
          </Alert>
